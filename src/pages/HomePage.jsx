         ...
         <div className="row justify-content-center">
          <div className="col-6">
             <div className="rounded-space mx-auto">
              <img src="../public/avatar.jpg" className="img-fluid" alt="" />
             </div>
            </div>
           </div>
        <h1 className="fw-bold m-5" id="presentationContainer"><span id="presentationName">I'm Erik Gotijo</span>, a Full Stack Software Engineer. </h1>
