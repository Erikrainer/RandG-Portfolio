      ...
      case 1:
        return (
          <>
            ...
            <BigProjectCard
              title="Demo Game"
              imageName="DemoGame.png"
              description="For my course, I created my first game using Unreal Engine 5. It’s a simple project designed to demonstrate the engine's basic features. In the game, players can move, collect orbs, and face challenges like falling off the map or taking damage, which results in a game over.
The main objective is to collect all the orbs to unlock a door and progress. The game includes environmental ambient sounds, sound effects, and background music with triggered changes based on player actions. It also features essential mechanics like restarting the game, quitting, and basic physics for interactions."
              siteLink="https://1drv.ms/u/s!AhObPZJDkiIE1xJGKIs1eltXlcGn?e=FgOVTp"
              githubLink="https://github.com/Erikrainer"
            />
            {/* <div className="row">
        {currentPage === 1 && (
          <>
